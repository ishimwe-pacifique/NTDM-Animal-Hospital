...
export default function FarmerSidebar() {
  ...
  const navItems = [
    ...
    { href: "/farmer/milk", label: "Milk Production", icon: <Milk className="h-4 w-4 sm:h-5 sm:w-5" /> },
    ...
    { href: "/farmer/insemination", label: "Insemination", icon: <Syringe className="h-4 w-4 sm:h-5 sm:w-5" /> },
