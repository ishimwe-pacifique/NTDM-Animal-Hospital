      ...
      <div className="mb-8">
        <div className="flex items-center space-x-3 mb-2">
          ...
          <div>
            ...
            <p className="text-blue-600 font-medium">Veterinary Dashboard</p>
          </div>
        </div>
        <p className="text-gray-600 ml-14">Monitor your practice and patient care activities</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card className="border-l-4 border-l-orange-500 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-gray-700">Pending Consultations</CardTitle>
        ...
        <Card className="border-l-4 border-l-blue-500 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-gray-700">Total Consultations</CardTitle>
        ...
        <Card className="border-l-4 border-l-green-500 shadow-md hover:shadow-lg transition-shadow">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-semibold text-gray-700">Completed Cases</CardTitle>
        ...
        <Card className="shadow-md border-0 bg-white">
          <CardHeader className="bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-t-lg">
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="text-lg font-semibold">Recent Patient Cases</CardTitle>
            </div>
          </CardHeader>
            ...
            <div className="space-y-4">
              {recentAppointments.length > 0 ? (
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No recent patient cases</p>
                </div>
              )}
            </div>
          </CardContent>
        ...
        <Card className="shadow-md border-0 bg-white">
          <CardHeader className="bg-gradient-to-r from-purple-500 to-purple-600 text-white rounded-t-lg">
            <div className="flex items-center space-x-2">
              ...
              <CardTitle className="text-lg font-semibold">Patient Communications</CardTitle>
            </div>
          </CardHeader>
          <CardContent className="p-6">
            <div className="space-y-4">
